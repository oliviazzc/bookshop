      ...
      <tr>
        ...
        <br />
            <br />
              ...
              <p color="red">付款已经完成~</p></h3>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div></div>
          <a href="${ pageContext.request.contextPath }/order_findByUid.action?page=1">返回我的订单</a>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="${ pageContext.request.contextPath }/index.action">继续购物</a>
         </td>
      </tr>
    </table>
    <h1>&nbsp;</h1></td>
